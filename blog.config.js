...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '北极花式摔角', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '个人博客写写字🤼‍♀️', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://spirituallyfinn.life', // 网站地址
